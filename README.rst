...
.. note::
   ...
   distribution, and users need to `build it from source <doc/installation.rst>`_.
...
See the documentation's `usage <doc/usage.rst>`_ section for more details on how to run the node and verify its operation.
